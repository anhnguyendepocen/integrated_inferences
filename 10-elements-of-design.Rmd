...
Formally, define the loss function for query $Q$ given data $K$ as:

$$E_{k, q} \left(\left( \int q' P(q' | k, w)dq' - q\right)^2\right)$$

where the expectation is taken over the joint distribution of $K$ and $Q$, given $W$. This is measure of expected loss is sometimes called the *Bayes risk*. The inner term $P(q'|k, w)$ is the posterior distribution on $q'$ given observation of $k$ and $w$. 
