...
In all we havefour qualifying types: $\theta_{00}^{01}$, $\theta_{01}^{01}$, $\theta_{10}^{01}$, and $\theta_{11}^{01}$ (or 2, 4, 10, and 12). In other words, we can attribute a $Y=1$ outcome to $X1=1$ when $X2=1$ and the causal type is one of these four. By parallel reasoning, we can also attribute a $Y=1$ outcome to $X1=1$ when $X2=0$ and the causal type is any of $\theta_{01}^{00}$, $\theta_{01}^{01}$, $\theta_{01}^{10}$, and $\theta_{01}^{11}$. 
