...
In all we have four qualifying types: $\theta^Y_{0001}$, $\theta^Y_{1001}$, $\theta^Y_{0101}$, $\theta^Y_{1101}$. In other words, we can attribute a $Y=1$ outcome to $X_1=1$ when $X_2=1$ and $Y$'s nodal type is one of these four.  
