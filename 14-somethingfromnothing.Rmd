...
result4 <- query_model(updated_all, queries = "Y[X=0] == 0", subsets = subs, using = "posteriors")
...
kable(frank[[1]][,-c(1,3)], caption = "Clue is uninformative in Study 1")

kable(frank[[2]][,-c(1,3)], caption = "Clue is also uninformative in Study 2 (factorial)")

kable(frank[[3]][,-c(1,3)], caption = "Clue is also uninformative in Study 3 (experiment studying $K$)")
