...
```{r lowdem, echo = FALSE, fig.width = 8, fig.height = 5, fig.align="center", out.width='.7\\textwidth', fig.cap = "A lower-level model of democratization in which inequality may affect regime type both directly and through mobilization of the lower classes, and international pressure may also affect regime type."}
...
hj_ggdag(x = c(1,1.5,3,3, 1.5, 2.2),
         ...
         padding = 0.5,
         labels = TRUE,
         force = 0, force_pull = -.03, direction='y'
)
