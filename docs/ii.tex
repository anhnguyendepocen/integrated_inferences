...
\begin{figure}
\includegraphics[width=0.5\linewidth]{ii_files/figure-latex/spillover-1} \caption{Model with spillovers: the treatment status of two units each affect the outcomes for both.}\label{fig:spillover}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/ch16pimdgraphs-1.pdf}
