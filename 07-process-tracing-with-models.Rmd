...
**Causal types**. From the set of all possible nodal types for a DAG we get the set of all possible causal types by simply elaborating all possible permutations.
