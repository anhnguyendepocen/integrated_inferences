...
\begin{figure}
\includegraphics[width=0.95\linewidth]{ii_files/figure-latex/dag3d-1} \caption{Types, parameters, and priors}\label{fig:dag3d}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.95\linewidth]{ii_files/figure-latex/dag3d2-1} \caption{Types, parameters, and priors, with confounding}\label{fig:dag3d2}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-15}Data from non binary model (selection of rows)}
\centering
...
\caption{\label{tab:unnamed-chunk-17}Posteriors on potential outcomes for non binary model}
\centering
...
\caption{(Partially) Recovered DAGs from Data: Circles indicate uncertainty whether a aroow starts or ends at a given point.}\label{fig:disoveryplotsab}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-43}Inferences on the probability that $X$ caused $Y$ upon seeing $M=0$ or $M=1$ for a range of possible values of $\lambda^Y_{10}$}
\centering
\begin{tabular}[t]{r|r|r|r}
\hline
