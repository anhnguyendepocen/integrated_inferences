...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/CluesInferences1-1.pdf}
...
\caption{\label{fig:correlation} Joint posteriors distribution on whether a case is a $b$ or $d$ and on the probability of seeing a clue for a $b$ type ($\phi_b$).}\label{fig:correlation}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/ch5joint-1.pdf}
\caption{\label{fig:ch5joint}Correlated beliefs on queries and probative value}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/showstrats5xxa-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/showstrats5xxb-1.pdf}
...
\hypertarget{justifying-probative-value-for-process-tracing}{%
\section{Justifying probative value for process-tracing}\label{justifying-probative-value-for-process-tracing}}
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/unnamed-chunk-41-1.pdf}
\caption{\label{fig:unnamed-chunk-41}Two models. The model on the right might be justified if \(X\) is known to be randomized.}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-42}Can observation of large N data render mediator $M$ informative for case level inference? Model 1: No knowledge of structure; Model 2: $X$ known to be randomized. Posterior SD in parentheses.}
\centering
...
\hline
\$\textbackslash{}Pr(X \textbackslash{}text\{  causes \}Y \textbackslash{}vert K=0)\$ & 0 & 0 & [.5, 1] & [2/3,1]\\
\hline
\end{tabular}
\end{table}
...
{\centering \includegraphics[width=0.8\linewidth]{ii_files/figure-latex/plots-1} 

}

\caption{(Partially) DAGs from Data: True DAGs in upper row with partially directed graphs in lower row. Circles indicate uncertainty whether a aroow starts or ends at a given point.}\label{fig:plots-1}
\end{figure}
\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{ii_files/figure-latex/plots-2} 

}

\caption{(Partially) DAGs from Data: True DAGs in upper row with partially directed graphs in lower row. Circles indicate uncertainty whether a aroow starts or ends at a given point.}\label{fig:plots-2}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-44}Regression coefficient on $X$ given $M=0$ and $M=1$}
\centering
...
\caption{\label{tab:unnamed-chunk-45}Inferences on the probability that $X$ caused $Y$ upon seeing $M=0$ or $M=1$ for a range of possible values of $\lambda^Y_{10}$}
\centering
\begin{tabular}[t]{r|r|r|r}
\hline
...
\begin{figure}
\centering
\includegraphics{ii_files/figure-latex/pimdgraphs215-1.pdf}
\caption{\label{fig:pimdgraphs215}ATE of I on D.}
\end{figure}
