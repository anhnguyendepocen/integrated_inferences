...
In the top row, we see our pure prior on these queries before we have even seen the $X,Y$ correlation --- i.e., based strictly on the DAG and flat priors over nodal types. The story here is straightforward. To return to our convenient $a, b, c, d$ typology, we start out believing that, for the $X \rightarrow M$ relationship, the population is evenly divided across the four types. Likewise for the $M \rightarrow Y$ relationship.  population of cases to be evenly split among these four types   
