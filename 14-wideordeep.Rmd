...
The widest strategy is better than the deepest strategy if and only if $1600w < 100w + 100d$, that is, when $w < 0.07d$. In other words, breadth has to be much cheaper than depth for the maximally wide strategy to be preferred to the maximally deep strategy. The mixed strategy is better than the maximally deep strategy if and only $400w + 50d < 100w + 100d$, that is when $w < 0.17d$. And the maximally wide strategy is better than the mixed strategy if and only if $1600w < 400w + 50d$, or $w < 0.04d$. 

Thus, roughly speaking, if $w < 0.04d$, our preference-ordering is widest > mixed > deepest. If $0.07d > w > 0.04d$, our ordering is mixed > widest > deepest. And if $0.07d < w < 0.17d$, our ordering is mixed > deepest > widest. 
