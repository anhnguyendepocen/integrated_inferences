...
teststable[c(2, 4, 6), j] <- paste0("(", teststable[c(2, 4, 6), j], ")")}
  ...
  teststable %>% 
  kable(caption= "Classic tests with probative value inferred from (simulated) data, for query, Does $X$ have a positive effect on $Y$ in this case?", row.names = FALSE, booktabs = TRUE)
```
