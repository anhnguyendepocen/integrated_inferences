...
We start by establishing the possibility of justification.
...
`r colorize()` Put bounds in empty cells.
...
teststable <- 
  cbind(drop_sd(tests[[1]]),  
      ...
      `Straw in the Wind Test` = drop_sd(tests[[4]])[,4]
