...
```{r disoveryplotsab, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "(Partially) Recovered DAGs from Data: Circles indicate uncertainty whether a aroow starts or ends at a given point.", fig.width = 8, fig.height = 5, results='hide',fig.keep='all', eval = TRUE, fig.align = "center", out.width = "80%"}
par(mfrow = c(1,3))
