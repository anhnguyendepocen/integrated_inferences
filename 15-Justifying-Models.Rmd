...
The procedures given in Chapter \@ref(mixing) let us form posteriors over inferences with finite data. To illustrate, we first make use of a function that generates data from a model with a constrained set of types for $Y$ and a given prior distribution over clue $K$. We retain the $Y$ types in which only $X$ matters, only $K$ matters, or you have to have both. 
