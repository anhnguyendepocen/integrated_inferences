...
While `CausalQueries` can implement singel-case inference, it is helpful for researchers to be able to reason their way through what is happening "under the hood." We provide here some core intuitions for thinking about the features of models and queries that influence whether and how much we can learn from within-case observations.
