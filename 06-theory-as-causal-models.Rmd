...
What models might imply model $M$? The figure points to two. Both models $M^\prime$ and  $M^{\prime\prime}$ imply model $M$. They can be thought of as  *theories*, or lower-level model, of $M$. 
...
EXPLANATION AS UNPACKING OF THETA
