...
::: {.center data-latex=""}
:::
We describe an approach in which theoretical claims are thought of as model justifications within a  hierarchy of causal models. Lower-level models serve as a theory for a higher level model if the higher level model can be deduced from the lower level model---possibly in combination with data. The empirical content of a lower level model is the possible reduction in variance of the higher level model that it can provide. 
::::
<br>
...
The rest of this chapter builds out this idea and uses it provide a way of characterizing when a theory is useful or not. 
...
### Implications of probabilistic causal models
...
The gains from this formalization of theory as lower level models come at a cost: they impose a structure on how models need to related to each other.  
