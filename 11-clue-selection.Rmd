...
prices_pimdconfound2 <- c(1, .5, 1, 1)
...
results_pimdconfound2 <- t(apply(strategy_list_pimdconfound2, 1, function(j) 
  ...
  data.frame()
  write_rds(results_pimdconfound2, "saved/ch11_tradeoffs_pimd2.rds")
  }
results_pimdconfound2 <- read_rds("saved/ch11_tradeoffs_pimd2.rds")

kable(data.frame(cbind(strategy_list_pimdconfound2, results_pimdconfound2) ), digits = 4)
# Plot results
with(results_pimdconfound2, plot(expected_costs, expected_variance, main = "Tradeoffs over strategies | Democracy model with confound"), xlab = "Expected costs of strategy", ylab = "Expected posterior variance from strategy")
