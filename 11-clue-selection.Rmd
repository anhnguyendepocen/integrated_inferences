...
FLAG: Table \@ref(pimdlearn_i1d1) needs a FIRST column defining the strategies.
...
kable(inferences2, caption = "\\label{possible_outcomespimd_i0} Table shows possible data patterns for P and M given I = 1 and D = 1 together with the probability of observing each data realization given data is sought on a variable and the posterior given that data realization.", digits = 3)
...
inferences <-
  conditional_inferences(pimd_priors, query = "M[I=1] < M[I=0]" & "D[M[I=0]] > D[M[I=1]]" & "D[I=1, M[I=1]] = D[I=0, M[I=1]]", given = "I==0 & D==1")
