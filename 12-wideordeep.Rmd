...
if(do_diagnosis){
 ...
 for(m in  1:length(models)) {for(g in 1:length(givens)) {	
    filename <-  paste0("saved/Ch12_", names(models)[m], "_",  names(givens)[g], ".rds")
...
# JULIANS'S GRAPH FUNCTION / MAYBE ADD TO _packages_used.R
