...
We see that we can learn about the $ATE$ by collecting additional $X, Y$ data. Indeed, we learn about as much from greater breadth in the 2-path the learning about average effects from $X, Y$ data appears fairly insensitve to the number of causal paths between $X$ and $Y$ in our model.
