...
We want to examine data on $M$ for two of these cases and are wondering about what strategy we shoul use to select the cases. We are considering three strategies:
...
Different strategies yield different possible types of data. Each one of these is likely to arise with a different probability and is associated with a different inference. This allows us to assess the *expected* posterior variance associated with each strategy. 
