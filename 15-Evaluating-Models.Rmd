...
and under the unrestricted models:  `r,  formatC(loo_unrestricted$loo_likelihood, format = "e", digits = 2)`. An improvement on the order of   `r,  formatC(loo_restricted$loo_likelihood/loo_unrestricted$loo_likelihood, format = "e", digits = 2)`. 
