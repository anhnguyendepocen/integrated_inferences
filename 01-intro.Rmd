...
- A grounding for probative value
...
- Systematic integration — using both qual and quant to both help answer any given query. in fact, no fundamental difference between quant and qual data — which may displease some readers but offers big advantages, including:
...
- Which provides a model for cumulation
