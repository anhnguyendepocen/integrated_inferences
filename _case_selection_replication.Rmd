...
run <- TRUE
run_selection_1 <- TRUE
run_selection_2 <- TRUE
simulation_diagnosis <- TRUE
path <- "saved/case_selection"
```
...
if(run_selection_1) 
write_rds(inf, "saved/case_selection/case_selection_16_10000.rds") 
```
...
if(run_selection_2) 
write_rds(inf_6_of_8, "saved/case_selection/case_selection_6_of_8.rds") 

inf_6_of_8 <- read_rds("saved/case_selection/case_selection_6_of_8.rds") 
...
all_results <- read_rds("saved/case_selection/case_selection_16_10000.rds")  
...
write_rds(case_selection_1, "saved/case_selection/Case_selection_1.rds")
...
write_rds(case_selection_2, "saved/case_selection/Case_selection_2.rds")
```
...
files <- files[!grepl('Case_selection.',files)]
