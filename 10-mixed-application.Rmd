...
```{r mixedhist, echo =FALSE, fig.cap = "Posteriors on Causes of Democratization", warning = FALSE}
...
```{r mixedhist2, echo =FALSE, fig.cap = "Posteriors on Causes of Democratization", warning = FALSE}
