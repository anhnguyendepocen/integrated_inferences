...
Note finally that full specification of the model also requires a distribution over the $\theta$s, specifically a specificaton of $\{\lambda^C, \lambda^S, \lambda^P, \lambda^R\}$ (and by assumption, here,  $\lambda^A, \lambda^B$ are degenerate).
