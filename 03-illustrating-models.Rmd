...
* $A=CS$, implying that retrenchment makes it on the agenda if and only if  conservatives are in power *and* socioeconomic pressures are high. We might further imagine an error whereby $CS$ is observed with probability $p$ and $1-CS$ with probabilty $1-p$. 
