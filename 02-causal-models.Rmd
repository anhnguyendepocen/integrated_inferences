...
The three components of a causal model are (i) the variables---which variables are we focused on and how are they defined (ii) the functional relations---which variables are "explained" by which other variables and how, and (iii) probability distributions over unexplained elements of a model. 
