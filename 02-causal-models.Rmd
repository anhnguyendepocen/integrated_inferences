...
```{r elimrules, echo = FALSE, fig.width = 10, fig.height = 13,  fig.align="center", out.width='.5\\textwidth', fig.cap = "Here we represent the basic principles for eliminating exogenous nodes."}
p1 <- hj_ggdag(
  x = c(1,2,2),
  y = c(2,3,1),
       names = c(
