...
In showing how we can inscribe beliefs into a causal model, this chapter has set out the foundations of the book's analytic framework. Causal models are both the starting point for analysis in this framework and the object about which we seek to learn. Before building on this foundation, we seek in the next chapter to reinforce its the reader's understanding of how causal models can be used to inscribe causal beliefs. We do so by illustrating how a set of prominent social scientific arguments can be represented as causal models. 
