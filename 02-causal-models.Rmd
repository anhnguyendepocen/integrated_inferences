...
Causal claims are everywhere. Causal knowledge is often the end goal of  empirical social science. It is also often a key input into causal inference: indeed rarely do we arrive at causal inquiry fully agnostic about causal relations in the domain of interest.^[As nicely put by @cartwright1994nature, no causes in, no causes out, a point we retun to more formally later.] 
Indeed, causal assumptions  can have profound implications for research design and inference. Causal assumptions are also hidden is seemingly descriptive statements: claims that someone is guilty, or exploited, or powerful, or weak, involve beliefs about how things would be were conditions different. Even when scholars carefully try to avoid causal claim making, causal verbs--depends, drives, produces, influences---surface.     

But while causal claims are commonplace it is not always clear what is meant by a causal relations and how causal knowledge about one thing can be marshaled to justify causal claims about another. For the purposes of this book, the counterfactual model of causality addresses the first question. Causal models address the second.
