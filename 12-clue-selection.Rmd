...
kabble(dfl, col.names = c("Strategy", "Given", "Prior belief", "Prior Uncertainty", "Expected Posterior Uncertainty"), caption = "Expected learning from different clue selection strategies. Each strategy is a group of nodes on which within case data is gathered. ")
```
...
dfl <- t(learning) %>% data.frame() %>%
  mutate(prior_estimand= round(as.numeric(prior_estimand), 3),
         prior_var = round(as.numeric(prior_var), 3),
         E_post_var = round(as.numeric(E_post_var), 3))
kabble(dfl, col.names = c("Strategy", "Given", "Prior belief", "Prior Uncertainty", "Expected Posterior Uncertainty"), caption = "Expected posterior variance from different clue selection strategies (less restricted model).")
...
kabble(dfl, col.names = c("Strategy", "Given", "Prior belief", "Prior Uncertainty", "Expected Posterior Uncertainty"), caption = "Expected posterior variance from different clue selection strategies. (Stonger priors on S=1)")
```
